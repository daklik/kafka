...
_Deliverable_: Gap analysis report with prioritized backlog mapped to Node.js modules.
...
_Deliverable_: Expanded `StreamsBuilder`/DSL API with parity tests referencing Java behavior.
